...
# Execute the script
/soft/MATLAB/R2015b/bin/matlab -nosplash -nodesktop -nodisplay -r "run /homedtic/fwilhelmi/workspace/code/Experiment_5_Performance_Comparison_Random_Network.m"
