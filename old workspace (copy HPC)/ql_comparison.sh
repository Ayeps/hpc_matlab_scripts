...
# -------------------------------------------------
#$ -o /homedtic/fwilhelmi/workspace/output/ql_comp_output.out
#$ -e /homedtic/fwilhelmi/workspace/output/ql_comp_error.err
#
...
# Execute the script
/soft/MATLAB/R2015b/bin/matlab -nosplash -nodesktop -nodisplay -r "run /scratch/COMP_Experiments/script/Comparison_QL.m"
# Copy data back, if any
printf "Matlab processing done. Moving data back\n"
mv /scratch/QL_Experiments/script/final_comparison_ql.mat /homedtic/fwilhelmi/workspace/final_comparison_ql.mat
