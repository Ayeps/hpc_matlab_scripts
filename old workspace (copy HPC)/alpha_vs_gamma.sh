...
# -------------------------------------------------
#$ -o /homedtic/fwilhelmi/workspace/output/ql_output.out
#$ -e /homedtic/fwilhelmi/workspace/output/ql_error.err
#
...
# Execute the script
/soft/MATLAB/R2015b/bin/matlab -nosplash -nodesktop -nodisplay -r "run /scratch/QL_Experiments/script/ql_alpha_vs_gamma.m"
