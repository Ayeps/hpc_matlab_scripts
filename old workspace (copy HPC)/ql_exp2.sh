...
# -------------------------------------------------
#$ -o /homedtic/fwilhelmi/workspace/output/ql_exp2_output.out
#$ -e /homedtic/fwilhelmi/workspace/output/ql_exp2_error.err
#
...
# Execute the script
/soft/MATLAB/R2015b/bin/matlab -nosplash -nodesktop -nodisplay -r "run /scratch/QL_Experiments/script/Experiment_2_QL_tune_params.m"
